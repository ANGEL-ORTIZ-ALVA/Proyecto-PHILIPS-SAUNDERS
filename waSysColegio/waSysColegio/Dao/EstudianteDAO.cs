...
namespace waSysColegio.Dao
{
    public class EstudianteDAO
    {
        ...
        public Models.Estudiante BuscarEstudiantePorID(int idEstudiante)
        {
        ...
        public string InsertarEstudiante(Models.Estudiante estudiante)
        {
            string mensaje = null;
        ...
        public string ActualizarEstudiante(Models.Estudiante estudiante)
        {
            string mensaje = null;
        ...
        //Para MVC
        //Listar Estudiante
        public List<Models.Estudiante> listarEstudiante()
        {
            List<Models.Estudiante> lista = new List<Models.Estudiante>();
        ...
        //estudiante por id
        public Models.Estudiante ObtenerEstudiantePorId(int idEstudiante)
        {
            Models.Estudiante estudiante = null;
        ...
        public int ObtenerSeccionPorEstudiante(int idEstudiante)
        {
            int idSeccion = 0;
            string query = "SELECT ID_Seccion FROM Estudiante WHERE ID_Estudiante = @idEstudiante";
            ...
            using (SqlCommand command = new SqlCommand(query, connection))
            {
                ...
                connection.Open();
                idSeccion = (int)command.ExecuteScalar();
            }
