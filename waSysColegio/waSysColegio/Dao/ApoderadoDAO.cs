...
namespace waSysColegio.Dao
{
    public class ApoderadoDAO
    {
        ...
        //Listar apoderados
        public DataTable listapoderados()
        {
        ...
        public void AgregarApoderado(string nombre, string apellido, string dni, string correo, string telefono, string direccion, string estadoRegistro, string genero, string nombreUsuario)
        {
            try
            {
                string connString = ConfigurationManager.ConnectionStrings["apo"].ToString();
        ...
        public bool ExisteApoderadoPorUsuario(string nombreUsuario)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                string query = "SELECT COUNT(*) FROM Apoderado WHERE ID_Usuario = (SELECT ID_Usuario FROM Usuario WHERE Nombre_Usuario = @Nombre_Usuario)";
                SqlCommand cmd = new SqlCommand(query, conn);
